...
<div>
    ...
    <div style={{backgroundColor:"#0000",padding:"20px",border:"1px solid white",borderRadius:"1px",paddingLeft:"400px",fontSize:'35px'}}>
      <td>
       <th>
       <Link component={RouterLink} to="/InPatient" color="primary" style={{textDecoration: 'none',color: 'black',}}>
        InPatient / 
        </Link>
        </th>
       <th>
       <Link component={RouterLink} to="/OutPatient" color="primary" style={{textDecoration: 'none',color: 'black',}}>
        OutPatient  / 
        </Link>
        </th>
       <th>
       <Link component={RouterLink} to="/HospitalAnalysis" color="primary" style={{textDecoration: 'none',color: 'black',}}>
        Day-Day Records / 
        </Link>
        </th>
       <th>
