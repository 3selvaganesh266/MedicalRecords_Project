...
export default function Aashish() {
  return(
  <div
  style={{
      ...
      <Table sx={{ minWidth: 700,marginBottom:40,marginTop:15,marginLeft:50,width:100}}>
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell>Aashish</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>45</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>watson</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>kavi</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>Left Nee</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>Dr.Mohan</StyledTableCell>
