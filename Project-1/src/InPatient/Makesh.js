...
export default function Makesh() {
  return(
  <div
  style={{
      ...
      <Table sx={{ minWidth: 700,marginBottom:40,marginTop:15,marginLeft:50,width:100}}>
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell>Makesh</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>25</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>10/12/2023</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>Shapin</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>Aishu</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>A+</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>Dr.Amardeep</StyledTableCell>
