...
export default function Poormila() {
  return(
  <div
  style={{
      ...
      <Table sx={{ minWidth: 700,marginBottom:40,marginTop:15,marginLeft:50,width:100}}>
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell>Poormila</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>20</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>Maari</StyledTableCell>
