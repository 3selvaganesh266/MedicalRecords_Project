      ...
      <Table sx={{ minWidth: 700,marginBottom:40,marginTop:15,marginLeft:50,width:100}}>
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell>Babin</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>Jones</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>Maria</StyledTableCell>
