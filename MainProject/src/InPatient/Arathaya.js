...
export default function Aradhya() {
  return(
  <div
  style={{
 ...
 <TableContainer>
      <Table sx={{ minWidth: 700,marginBottom:40,marginTop:15,marginLeft:50,width:100}}>
        <TableHead>
          <TableRow>
            <StyledTableCell>Name</StyledTableCell>
            <StyledTableCell>Aradhya</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>19</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>19/12/2023</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>Mandhan</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>Archana</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>AB+</StyledTableCell>
        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell style={{backgroundColor:green}}>Dr.Prashath</StyledTableCell>
